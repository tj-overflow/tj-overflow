...
- **Core interests:** Opponent modeling, sequential decision-making under
  uncertainty, multi-agent systems, and search/planning applied to economic games.
- **Coursework (MCS):** Machine learning, NLP, and Bayesian modeling.

## Tech Stack

- **Languages:** Python, C++
- **Modeling & compute:** Bayesian inference, probabilistic modeling,
  GPU-accelerated agent-based simulation at scale
- **Engineering:** NumPy / SciPy · Git · LaTeX
...
- **Procurement Sentinel** *(in development)* An autonomous agent for B2B SaaS
  ...
  the other side's true valuations. A natural-language layer for parsing contract
  terms is planned as a future extension.
...
- [Medium](https://medium.com/@taejun.oh5) — writing on the intersection of game theory and AI
